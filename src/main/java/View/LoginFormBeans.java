 ...
 * @author ME
 */
public class LoginFormBeans extends javax.swing.JFrame {
...
//            java.util.logging.Logger.getLogger(LoginFormBeans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//    }
    ...
    /**
     * Creates new form LoginFormBeans
     */
    ...
    private void initComponents() {
        ...
        jButton2.setToolTipText("Click Here to Register");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        validation = new Validation(user =
                new UserInformation("", "", userName, userPassword));

        if (validation.loginUser(user)) {
            dispose();
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
        ...
        JOptionPane.showMessageDialog(this,
                validation.loginUserValidationMessages(user));
